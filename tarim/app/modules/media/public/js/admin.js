...
class Modal extends _plugin__WEBPACK_IMPORTED_MODULE_1__["default"] {
    ...
    constructor(options) {
        ...
        /** @param {HTMLElement} */
        this.content = this.style === 'card' ? _core__WEBPACK_IMPORTED_MODULE_0__["default"].findOrCreateElement('.modal-card', this.element) : _core__WEBPACK_IMPORTED_MODULE_0__["default"].findOrCreateElement('.modal-content', this.element);
        ...
        if(this.closable) {
            /** @param {HTMLElement} */
            this.closeButton = this.style === 'card' ? _core__WEBPACK_IMPORTED_MODULE_0__["default"].findOrCreateElement('.delete', this.header, 'button') : _core__WEBPACK_IMPORTED_MODULE_0__["default"].findOrCreateElement('.modal-close', this.element, 'button');
        }
...
/***/ "./resources/assets/admin/css/admin.scss":
/*!***********************************************!*\
  !*** ./resources/assets/admin/css/admin.scss ***!
  \***********************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _controllers_layouts_media_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controllers/layouts/media_controller */ "./resources/assets/admin/js/controllers/layouts/media_controller.js");
/* harmony import */ var _controllers_fields_picture_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./controllers/fields/picture_controller */ "./resources/assets/admin/js/controllers/fields/picture_controller.js");
/* harmony import */ var _controllers_fields_upload_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controllers/fields/upload_controller */ "./resources/assets/admin/js/controllers/fields/upload_controller.js");




if (typeof window.application !== 'undefined') {
  window.application.register('fields--picture', _controllers_fields_picture_controller__WEBPACK_IMPORTED_MODULE_1__["default"]);
  window.application.register('fields--upload', _controllers_fields_upload_controller__WEBPACK_IMPORTED_MODULE_2__["default"]);
  window.application.register('layouts--media', _controllers_layouts_media_controller__WEBPACK_IMPORTED_MODULE_0__["default"]);
}

/***/ }),

/***/ "./resources/assets/admin/js/controllers/fields/picture_controller.js":
/*!****************************************************************************!*\
  !*** ./resources/assets/admin/js/controllers/fields/picture_controller.js ***!
  \****************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _vizuaalog_bulmajs_src_plugins_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @vizuaalog/bulmajs/src/plugins/modal */ "./node_modules/@vizuaalog/bulmajs/src/plugins/modal.js");
...
function (_window$Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "imageSelect",
    value: function imageSelect(event) {
    ...
    key: "showModal",
    value: function showModal(file) {
      var src = this.createObjectURL(file);
      this.modal = new _vizuaalog_bulmajs_src_plugins_modal__WEBPACK_IMPORTED_MODULE_0__["default"]({
        style: 'modal',
        closable: false,
      ...
      this.cropper = new cropperjs__WEBPACK_IMPORTED_MODULE_1___default.a(image, options);
      this.addControl(this.cropper);
    }
  }, {
    key: "addControl",
    value: function addControl(cropper) {
      var self = this;
      var w = cropper.getImageData().width;
      var h = cropper.getImageData().height; // first line controller

      var control = $("<div class='image-controls has-padding-6'></control>");
      $(".cropper-frame").append(control);
      var disabled = this.lock == "lock" ? "disabled" : "";
      ...
      control.append([resize, rotate]); // control events
    ...
    key: "setSize",
    value: function setSize(cropper, w, h) {
    ...
    key: "createObjectURL",
    value: function createObjectURL(object) {
...
/***/ "./resources/assets/admin/js/controllers/fields/upload_controller.js":
/*!***************************************************************************!*\
  !*** ./resources/assets/admin/js/controllers/fields/upload_controller.js ***!
  \***************************************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _default; });
/* harmony import */ var _layouts_media__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../layouts/media */ "./resources/assets/admin/js/layouts/media.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_window$Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      this.media = new _layouts_media__WEBPACK_IMPORTED_MODULE_0__["default"]({
        'params': {
          name: name
        }
      });
...
/***/ "./resources/assets/admin/js/controllers/layouts/media_controller.js":
/*!***************************************************************************!*\
  !*** ./resources/assets/admin/js/controllers/layouts/media_controller.js ***!
  \***************************************************************************/
/*! exports provided: default */
...
function (_window$Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "passImages",
    value: function passImages(response) {
    ...
    key: "showContentItem",
    value: function showContentItem(index) {
    ...
    key: "initDropzone",
    value: function initDropzone(context) {
      ...
      var pond = filepond__WEBPACK_IMPORTED_MODULE_0__["create"](document.querySelector('#filepond'));
    }
  }], [{
    key: "targets",
    value: function targets() {
...
/***/ "./resources/assets/admin/js/layouts/media.js":
/*!****************************************************!*\
  !*** ./resources/assets/admin/js/layouts/media.js ***!
  \****************************************************/
/*! exports provided: default */
...
function () {
  ...
  _createClass(_default, [{
    ...
    value: function getMediaData() {
      ...
      axios.get(this.getOption('read_url'), {
        params: params
...
/***/ 0:
/*!******************************************************************************************!*\
  !*** multi ./resources/assets/admin/js/admin.js ./resources/assets/admin/css/admin.scss ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /home/algha/Documents/Python/Tarim-Env/Tarim/app/modules/media/resources/assets/admin/js/admin.js */"./resources/assets/admin/js/admin.js");
module.exports = __webpack_require__(/*! /home/algha/Documents/Python/Tarim-Env/Tarim/app/modules/media/resources/assets/admin/css/admin.scss */"./resources/assets/admin/css/admin.scss");
